...
from api.routes import arbitrage, autonomous, backtest, intelligence, phase9, risk, status, telegram, trading
...
def create_app(lifespan: Any = None) -> FastAPI:
    ...
    app.include_router(phase9.create_router(data_store))
